...
## Project Rules
- Preserve EN/RU route parity, canonical/hreflang relationships, forms, Chatbase, calendar, and existing integrations unless explicitly changing them.
- Do not introduce payroll services into offers or content.
